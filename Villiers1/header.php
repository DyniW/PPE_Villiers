  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="?p=home"><img src="villiers-sur-marne-94.png" alt="logo/home" style="width:37px;height:37px;">
</a></li>

        <li><a href="?p=presentation">Présentation</a></li>
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Prestations<span class="caret"></span> </a>
        <ul class="dropdown-menu">
          <li><a href="?p=prestations">Activités</a></li>
          <li><a href="?p=prestations">Horaires</a></li>
          <li><a href="?p=prestations">Tarifs</a></li>
